...
\draw[-Latex, thick] (recipe.south) -- ++(0,-0.4) -| (rattler.north);
...
\PY{+w}{  }\PY{n+nt}{host}\PY{p}{:}\PY{+w}{ }\PY{p+pIndicator}{[}\PY{n+nv}{python}\PY{p+pIndicator}{,}\PY{+w}{ }\PY{n+nv}{pip}\PY{p+pIndicator}{,}\PY{+w}{ }\PY{n+nv}{setuptools}\PY{p+pIndicator}{]}
